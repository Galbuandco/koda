...
Future<List<dynamic>> getMessages(user, talkback) async {
  ...
  for (var item in jsonlist) {
    ...
    if (item["tipo"] == "immagine" && !talkback) {
      messages.add(types.ImageMessage(
          ...
          uri: "https://storage.googleapis.com/pod_public/1300/200776.jpg"));
    } else {
...
class _ChatWidgetState extends State<ChatWidget> with WidgetsBindingObserver {
  ...
  void _checkTalkBackStatus() {
    final accessibilityFeatures = WidgetsBinding.instance.window.accessibilityFeatures;
    setState(() {
      talkback = accessibilityFeatures.accessibleNavigation;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: getMessages(widget.targetUser, talkback),
