      ...
      body: Center(
        child: Padding(
          ...
          child: Text(
              ...
              "I know you're angry, but anger brings you no where. \n\nPlease take a deep breath and consider talking to me to vent you anger. \n\nThen you can talk with your mate to solve the issue in a costructive way. Your mate has also been informed you need sometime by yourself, so no worries , take you time ;-)"),
        ),
      ),
    );
  }
